...
void Compare_Barlow_OO_TPCClusters70_FinalRings() {
    ...
    const char* variedFullPath   = "./3times2PC/Vn_LHC25ae_pass2_659588_TPCClusters70_Cent_0_20.root";
    const char* variedInnerCPath = "./3times2PC/Vn_LHC25ae_pass2_innerRing_FT0C_TPCClusters70_Cent_0_20.root";
    const char* variedInnerAPath = "./3times2PC/Vn_LHC25ae_pass2_innerRing_FT0A_TPCClusters70_Cent_0_20.root";
    const char* variedOuterCPath = "./3times2PC/Vn_LHC25ae_pass2_outerRing_FT0C_TPCClusters70_Cent_0_20.root";
    const char* variedOuterAPath = "./3times2PC/Vn_LHC25ae_pass2_outerRing_FT0A_TPCClusters70_Cent_0_20.root";
    ...
    TFile* out = TFile::Open("./3times2PC/Barlow_OO_vs_OO_TPCClusters70_FinalRings_Cent_0_20.root", "RECREATE");
    ...
    for (int harmonic = 2; harmonic <= 4; ++harmonic) {
        ...
        leg->AddEntry(hVaried, "O-O TPCClusters70", "lep");
        ...
        c->SaveAs(Form("./3times2PC/PDFs/Barlow_OO_TPCClusters70_FinalRings_v%d.pdf", harmonic));
    ...
    std::cout << "[Barlow final-rings] Wrote final ring-included Barlow outputs for O-O vs O-O TPCClusters70." << std::endl;
}
